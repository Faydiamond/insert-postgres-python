# -*- coding: utf-8 -*-
"""
Created on Tue Nov  9 22:54:02 2021
...
class insertBd:
    def load_excel(self):
        import csv
        self.archivo = open(r"C:\Users\FabiDiamanti\Documents\Fabian\entrevista_python\sales.csv",encoding="utf8")
    ...
    def ins_employs(self):
        ...
        self.cursor.executemany("INSERT INTO sales  ( ord_num, qty, payterns, stor_id, title_id )  VALUES ( %s,%s,%s,%s,%s )",self.tuplaa)
